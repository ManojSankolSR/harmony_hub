...
class _BottomplaylistsheetState extends State<Bottomplaylistsheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return SlidingUpPanel(
      ...
      color:
          Color.lerp(Colors.transparent, Colors.grey.shade900, dragProgress)!,
              ...
              if (snapshot.hasData) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final bool isPlaying = metadatasequence[index].tag.id ==
                    ...
                    return ListTile(
                        ...
                        leading: Container(
                          ...
                          child: widget.isFromDownloads
                              ? QueryArtworkWidget(
                                  ...
                                  id: int.parse(metadatasequence[index].tag.id),
                        ...
                        subtitle: Text(
                          widget.isFromDownloads
                              ? metadatasequence[index].tag.artist ?? "Unknown"
                              : metadatasequence[index].tag.extras["subtitle"],
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                        ),
                        trailing: isPlaying
                            ...
                            : widget.isFromDownloads
                                ...
                                : Row(
                                    ...
                                    children: [
                                      Likebutton(
                                          songData: metadatasequence[index]
                                              .tag
                                              .extras),
                                      AddToPlayListButton(
                                          songdata: metadatasequence[index]
