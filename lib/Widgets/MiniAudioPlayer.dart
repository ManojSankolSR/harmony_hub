...
class CustomRectTween extends RectTween {
  ...
  @override
  Rect lerp(double t) {
    final curvedT = curve.transform(t); // Apply the custom curve
...
class ModalAudioPlayer extends ConsumerStatefulWidget {
  @override
  ConsumerState<ModalAudioPlayer> createState() => _ModalAudioPlayerState();
}

class _ModalAudioPlayerState extends ConsumerState<ModalAudioPlayer> {
  @override
        ...
        child: Hero(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                color: artWorkColorScheme.surfaceContainer,
              ...
              child: StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData &&
                      ...
                      final isFromDownloads =
                          metadata.extras == null ? true : false;
                      return SingleChildScrollView(
                        child: Column(
                          children: [
                            Artworkwidget(
                                shadowcolor: artWorkColorScheme.primary,
...
class ExpandedAudioPlayerScreen extends ConsumerStatefulWidget {
  @override
  ConsumerState<ExpandedAudioPlayerScreen> createState() =>
      _ExpandedAudioPlayerScreenState();
}

class _ExpandedAudioPlayerScreenState
    extends ConsumerState<ExpandedAudioPlayerScreen> {
                        ...
                        slivers: [
                          ...
                          SliverToBoxAdapter(
                            child: Lyrics(
                                ...
                                metadata: metadata,
                                isLightMode: isLightMode,
                                artWorkColorScheme: artWorkColorScheme,
                                audioPlayer: audioPlayer),
                          ),
                          const SliverToBoxAdapter(
                            child: SizedBox(
                            ...
                            child: Card(
                              ...
                              child: Padding(
                                ...
                                child: MusicListWidget(musicData: {
                                  "title": "Artists",
                                  "data": metadata.extras!["artist_map"]
                                      ["artists"],
                                }),
                              ),
                            ),
  ...
  Widget Lyrics(
      ...
      required ColorScheme artWorkColorScheme,
      required AudioPlayer audioPlayer}) {
    // if (metadata.extras!["has_lyrics"]) {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 15),
      child: OpenContainer(
          middleColor: artWorkColorScheme.primary,
          tappable: false,
          closedColor: artWorkColorScheme.primary,
          openColor: artWorkColorScheme.primary,
          closedShape:
                    ...
                    children: [
                      ...
                      Positioned(
                          ...
                          child: Container(
                            ...
                            color: artWorkColorScheme.primary,
                            child: Row(
...
class _MiniAudioPlayerState extends ConsumerState<MiniAudioPlayer> {
  Future _getColorFromImage(String url) async {
    ...
    ref.read(artWorkColorSchemeProvider.notifier).state =
    ...
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData && snapshot.data!.currentSource != null) {
            ...
            // Check if the artwork URI has changed to avoid calling the function repeatedly
            if (metadata.artUri != null &&
                metadata.artUri.toString() != previousArtUri) {
              // Update previousArtUri to the current one
              previousArtUri = metadata.artUri.toString();

              // Call _getColorFromImage only if the artwork has changed
            ...
            return Padding(
              ...
              child: GestureDetector(
                ...
                onTap: () => {
                  pushScreen(context,
                      screen: ExpandedAudioPlayerScreen(),
                  ...
                  child: Hero(
                    createRectTween: (begin, end) {
                      return CustomRectTween(
                          begin: begin, end: end, curve: Curves.bounceInOut);
                    },
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: artWorkColorScheme.primary.withOpacity(.3),
                      ),
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
      ...
      builder: (context, snapshot) {
        return SizedBox(
          child: ProgressBar(
              ...
              progressBarColor: artWorkColorScheme.primary,
              progress: snapshot.data ?? Duration.zero,
              buffered: audioplayer.bufferedPosition,
              onSeek: (value) => audioplayer.seek(value),
              total: audioplayer.duration ?? Duration.zero),
...
//     // final MiniplayerController miniplayerController =
//     //     ref.watch(MiniplayerControllerProvider);
//     final double playerMaxHeight = 100.h;
//     final audioPlayer = ref.watch(globalPlayerProvider);
//     return StreamBuilder(
//         stream: audioPlayer.sequenceStateStream,
//         builder: (context, snapshot) {
...
//                   // ref.read(MiniplayerHeightProider.notifier).state = height;
            ...
            StreamBuilder<PlayerState>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (processingState == ProcessingState.loading ||
                    ...
                    return IconButton.filled(
                        iconSize: isForMiniPlayer ? null : 40,
                        color: Colors.white,
                        style: IconButton.styleFrom(
                          backgroundColor:
                              isLightMode ? Colors.black : Colors.white,
