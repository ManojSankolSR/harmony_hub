...
import 'package:harmony_hub/Widgets/MusicListWidget3.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return CustomScrollView(
      slivers: [
        ...
        //         width: 10,
        //       ),
        //       Chip(label: Text("Podcastst And Shows")),
        //     ],
        //   ),
        // ),
          ...
          child: ref.watch(HomeScreenDataProvider).when(
                data: (data) {
                  ...
                  return Column(
                    ...
                    children: [
                      MusicListWidget3(musicData: data["trending"]),
                      _nullCheckAndDisplayWidget(data, "charts"),
                      Musiclistwidget2(musicData: data["albums"]),
                  ...
                  return Skeletonizer(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Musiclistwidget2(
                            musicData: HomePageLoadingData["albums"]),
                        // Musiclistwidget2(
                        //     musicData: HomePageLoadingData["trending"]),
                        // _nullCheckAndDisplayWidget(
                        //     HomePageLoadingData, "charts"),
